...
export const REACTIONS: Reaction[] = [
  ...
  { eq: 'H2NCH2COOH + NaOH → H2NCH2COONa + H2O', type: ['neutralization'], note_vi: 'Nhóm COOH nhường proton; hai phản ứng này cho thấy tính lưỡng tính', note_en: 'The COOH group donates a proton; together these show amphoterism' },
