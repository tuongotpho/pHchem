...
> = {
  alkali: { vi: 'Kim loại kiềm', en: 'Alkali metal', color: 'bg-rose-500/25 border-rose-400/40', text: 'text-rose-200' },
  alkaline: { vi: 'Kim loại kiềm thổ', en: 'Alkaline earth', color: 'bg-orange-500/25 border-orange-400/40', text: 'text-orange-200' },
  transition: { vi: 'Kim loại chuyển tiếp', en: 'Transition metal', color: 'bg-amber-500/20 border-amber-400/40', text: 'text-amber-100' },
  'post-transition': { vi: 'Kim loại sau chuyển tiếp', en: 'Post-transition metal', color: 'bg-teal-500/20 border-teal-400/40', text: 'text-teal-100' },
  metalloid: { vi: 'Á kim', en: 'Metalloid', color: 'bg-cyan-500/20 border-cyan-400/40', text: 'text-cyan-100' },
  nonmetal: { vi: 'Phi kim', en: 'Nonmetal', color: 'bg-emerald-500/25 border-emerald-400/40', text: 'text-emerald-100' },
  halogen: { vi: 'Halogen', en: 'Halogen', color: 'bg-sky-500/25 border-sky-400/40', text: 'text-sky-100' },
  noble: { vi: 'Khí hiếm', en: 'Noble gas', color: 'bg-violet-500/25 border-violet-400/40', text: 'text-violet-100' },
  lanthanide: { vi: 'Họ Lantan', en: 'Lanthanide', color: 'bg-fuchsia-500/20 border-fuchsia-400/40', text: 'text-fuchsia-100' },
  actinide: { vi: 'Họ Actini', en: 'Actinide', color: 'bg-pink-500/20 border-pink-400/40', text: 'text-pink-100' },
