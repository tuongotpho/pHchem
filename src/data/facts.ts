...
export const FACTS: Fact[] = [
  ...
  { tag: 'Lịch sử', el: [8], vi: 'Antoine Lavoisier được coi là cha đẻ của hóa học hiện đại nhờ định luật bảo toàn khối lượng.', en: 'Lavoisier, father of modern chemistry, framed conservation of mass.' },
  ...
  { tag: 'Đời sống', el: [31], vi: 'Đèn LED phát sáng nhờ chuyển điện năng thẳng thành ánh sáng, ít tỏa nhiệt hơn đèn dây tóc.', en: 'LEDs convert electricity straight into light with little heat.' },
  ...
  { tag: 'Bất ngờ', nhom: ['ancol'], vi: 'Nếu bạn đổ đầy một cốc nước và một cốc cồn rồi trộn lại, thể tích tổng sẽ nhỏ hơn tổng ban đầu.', en: 'Mixing water and alcohol gives less volume than the sum of both.' },
  ...
  { tag: 'Công nghiệp', el: [11, 17, 1], vi: 'Điện phân dung dịch muối ăn cho ba sản phẩm giá trị: xút, khí clo và khí hydro.', en: 'Brine electrolysis yields caustic soda, chlorine and hydrogen.' },
  ...
  { tag: 'An toàn', el: [16], vi: 'Bình gas rò rỉ có mùi là do người ta cố tình pha thêm chất tạo mùi, khí gas vốn không mùi.', en: 'Gas leaks smell only because an odourant is added; the gas itself is odourless.' },
  { tag: 'An toàn', el: [9], vi: 'Axit flohydric nguy hiểm đặc biệt vì thấm qua da và phá hủy xương mà không gây đau ngay.', en: 'Hydrofluoric acid penetrates skin and attacks bone with little initial pain.' },
  ...
  { tag: 'Y học', el: [56], vi: 'Bari sunfat được uống trước khi chụp X-quang vì nó cản tia X mà không tan nên không gây độc.', en: 'Barium sulfate is swallowed for X-rays: it blocks rays but does not dissolve.' },
  ...
  { tag: 'Y học', nhom: ['ancol'], vi: 'Cồn 70% sát trùng tốt hơn cồn 90% vì nước giúp cồn thấm vào tế bào vi khuẩn.', en: 'Alcohol at 70% disinfects better than 90% because water helps it penetrate.' },
  { tag: 'Y học', nhom: ['ete', 'dan-xuat-halogen'], vi: 'Thuốc gây mê hiện đại bắt nguồn từ việc dùng ete và clorofom giữa thế kỷ 19.', en: 'Modern anaesthesia began with ether and chloroform in the 1800s.' },
  { tag: 'Y học', el: [11, 17], vi: 'Nước muối sinh lý có nồng độ 0,9% vì trùng với nồng độ muối trong máu.', en: 'Saline is 0.9% because that matches the salt level in blood.' },
  ...
  { tag: 'An toàn', el: [12], vi: 'Không dùng nước dập đám cháy magie: magie nóng đỏ tách được oxi từ nước, sinh khí hydro làm lửa bùng to hơn.', en: 'Never use water on a magnesium fire: hot magnesium strips oxygen from water, releasing hydrogen that feeds the flames.' },
